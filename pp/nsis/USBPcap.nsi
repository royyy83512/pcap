...
Section "USBPcap Driver" SEC_USBPCAPDRIVER
  ...
  ${If} ${RunningX64}
    ${If} ${AtLeastWin10} 
      File "..\Win8Release\dirs-Package\USBPcap.inf"
      File "..\Win8Release\dirs-Package\USBPcap.sys"
      File "..\Win8Release\dirs-Package\usbpcapx86.cat"
    ${ElseIf} ${AtLeastWin8}
      File "..\Win8Release\dirs-Package\USBPcap.inf"
      File "..\Win8Release\dirs-Package\USBPcap.sys"
      File "..\Win8Release\dirs-Package\usbpcapx86.cat"
...
Section "USBPcapCMD" SEC_USBPCAPCMD
  ...
  ${If} ${RunningX64}
    File /oname=USBPcapCMD.exe "..\USBPcapCMD\Win8Release\x86\USBPcapCMD.exe"
  ${Else}
    File /oname=USBPcapCMD.exe "..\USBPcapCMD\Win8Release\x86\USBPcapCMD.exe"
  ${EndIf}
